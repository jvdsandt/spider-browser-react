...
class CodeBrowser extends React.Component {
    constructor(props) {
        ...
        this.handleSelectedMethodChange = this.handleSelectedMethodChange.bind(this);
        this.handleSelectedMethodCategoryChange = this.handleSelectedMethodCategoryChange.bind(this);
